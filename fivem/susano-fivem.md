...
1.  Open the loader and select the first option you see, ensure you either have FiveM open or are already in a server, NOTE that if you are using a premium menu like Plaid.GG or Fivesense, you will need to be in the menu.
    
2.  Press the "Right Shift" key on your keyboard, then the Susano menu will appear, to close it simply press it again, note you can change this in the settings.
